...
class Orbit(object):
    def xyz2kep(self, r, v, re, ve, epoch, mass=None, dist=None):
        ...
        orbital elements:
        -Orbit.a: semi-major axis (cm)
        -Orbit.e: eccentricity
        -Orbit.i: inclination (rad)
        -Orbit.o: bigOmega (Longitude of the node) (rad)
        -Orbit.w: omega (Arguement of periastron) (rad)
        -Orbit.t0: Periastron Epoch (yr)
        -Orbit.p: period (yr)
        """
        cc = objects.Constants()
