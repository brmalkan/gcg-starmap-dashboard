#1/6/23 Edited by Max Kroft
#Updated functions used for absolute ref frame alignment to run in Python 3:
#Fixed print formatting
#Switched asciidata package to astropy.io.ascii package
#Adjusted syntax for the tables to astropy Table syntax
...
def findOverlapStars(mosaicRoot, mosaicStars, 
    ...
    shiftsTable = ascii.read(shiftsFile)
...
def mosaicDistortionErrors(rootDir, ep, mosaicRoot, mosaicStarlist,
    ...
    #
    ##########
    starlist = ascii.read(mosaicStarlist)
