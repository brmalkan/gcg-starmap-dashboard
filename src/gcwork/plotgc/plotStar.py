...
def go(star,root, align = 'align/align_d_rms_1000_abs_t', poly='polyfit_1000/fit',
    ...
    py.subplots_adjust(left=0.18,bottom=0.1,right=0.95,top=0.93,
    ...
    if LGSonly:
        legend_items = ['2004', '2005', '2006', '2007', '2008',
                        '2009','2010','2011', '2012','2013']
        legend_colors = ['green','greenyellow','gold','lightsalmon','orange',
        ...
        legend_colors = ['olive', 'brown', 'purple', 'darkslateblue', 'mediumblue',
                         ...
                         'lightsalmon', 'orange', 'darkorange','orangered', 'red',
                         'darkred', 'maroon','black','olive']
...
#    _fit.close()
    ...
    #py.savefig(root+'plots/plotStar_'+star+'_orbit'+suffix+'.png',transparent=True)    
    py.close(2)
    usetexFalse()
