...
class BHprops(object):
    ...
    def __init__(self, ntrials=100000):
        ...
        # S0-2 orbit in aligndir/11_10_26/
        ...
        # Latest S0-2 orbit in /g/ghez/align/13_08_21/
        self.massCenter = 4.6e6
        self.massSigma = 0.7e6
        self.distCenter = 8232.9
        self.distSigma = 670.0
    ...
    def generate_rho0(self):
        ...
        for ii in range(self.ntrials):
            rho0tmp = -1
            # Need to make sure we always get a positive value:
            while rho0tmp <= 0.0:
                rho0tmp = rho0gen.gauss(rho0ave, rho0sig)
            rho0[ii] = rho0tmp
